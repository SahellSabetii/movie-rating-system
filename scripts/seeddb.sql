...
\copy tmdb_movies_raw (budget,genres,homepage,id,keywords,original_language,original_title,overview,popularity,production_companies,production_countries,release_date,revenue,runtime,spoken_languages,status,tagline,title,vote_average,vote_count) FROM 'tmdb_5000_movies.csv' CSV HEADER ENCODING 'UTF8';

\copy tmdb_credits_raw (movie_id,title,"cast",crew) FROM 'tmdb_5000_credits.csv' CSV HEADER ENCODING 'UTF8';
